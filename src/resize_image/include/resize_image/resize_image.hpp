...
/**
 * @brief Resize images implemented via opencv's resize.
 *
 */
...
public:
  /**
   * @brief Construct a new Resize Image object.
   *
  ...
  /**
   * @brief Destroy the Resize Image object.
   *
...
private:
   ...
   *
   */
  const char * _pub_name = "~/image_resized";
